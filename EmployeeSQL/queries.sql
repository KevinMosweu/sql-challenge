...
-- 3. Listing department number, department name, employee number,
--    last name and first name of each department manager
SELECT dm.dept_no, dept_name, dm.emp_no, last_name, first_name
FROM dept_manager AS dm
INNER JOIN departments AS d ON dm.dept_no = d.dept_no
INNER JOIN employees AS e ON dm.emp_no = e.emp_no;

-- 4. Listing department number, employee number, last name,
--    first name and department name for each employee.
...
-- 5. Listing first name, last name and sex of each employee whose
--    first name is Hercules and whose last name begins with letter B.

SELECT first_name, last_name, sex
FROM employees
WHERE first_name = 'Hercules' AND last_name LIKE 'B%';

-- 6. Listing employee number, last name and first name of each
...
-- 7. Listing employee number, last name and first name and department
